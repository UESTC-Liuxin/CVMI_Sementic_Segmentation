'''
Author: Liu Xin
Date: 2021-11-21 18:34:24
LastEditors: Liu Xin
LastEditTime: 2021-11-21 21:29:55
Description: file content
FilePath: /CVMI_Sementic_Segmentation/utils/runner/optimizer/default_constructor.py
'''
import warnings
import torch
import torch.nn as nn
from utils.runner.optimizer.builder import OPTIMIZER_BUILDERS, OPTIMIZERS
from utils.registry import build


@OPTIMIZER_BUILDERS.register_module("DefaultOptimizerConstructor")
class DefaultOptimizerConstructor:
    ...
    def add_params(self, params, module:nn.Module, prefix='', is_dcn_module=None):
        ...
        # TODO: 原版的实现方式需要mmcv支持，这里修改一下
        is_norm = "Norm" in module.__class__.__name__
        is_dwconv = (
        ...
        # else:
        #     is_dcn_module = False
        is_dcn_module = "DeformConv2D" in module.__class__.__name__
    ...
    def __call__(self, model):
        ...
        if not self.paramwise_cfg:
            ...
            return build(optimizer_cfg, OPTIMIZERS)
