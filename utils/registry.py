...
class Registry:
    ...
    Args:
        ...
        build_func(func, optional): Build function to construct instance from
            Registry, func:`build` is used if neither ``parent`` or
    ...
    def _register_module(self, module_class, module_name=None, force=False):
        if not inspect.isclass(module_class) and module_name is None:
            raise TypeError('module must be a class or must specify module_name'
